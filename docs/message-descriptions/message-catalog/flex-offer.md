...
<FlexOffer
  ...
  ContractID            = String (only if this offer refers to a bilateral contract)
...
| Unit                  | The unit of Power that applies to the Power of the ISP's within the OfferOptions. (optional, if not specified, assume that the Power is specified in Watts)                                                                                                                                                                                  |
